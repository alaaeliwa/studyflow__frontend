...
export function TaskFormDialog({
  ...
  const resetForm = useCallback(() => {
    if (initialData) {
      ...
      setLinkedCourseId(initialData.linkedCourseId || "");
  ...
  const handleSave = () => {
    ...
    const selectedCourse = state.courses.find((course) => String(course.id) === String(linkedCourseId));
    const resolvedLinkedCourseTitle = selectedCourse?.title || linkedCourseTitle.trim() || undefined;
    ...
    onSave({
      ...
      linkedCourseTitle: resolvedLinkedCourseTitle,
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            {(!initialData || initialData.sourceModule === "general") && (
              <div className="space-y-2">
                ...
                <Select
                  value={linkedCourseId || "__general__"}
                  onValueChange={(value) => {
                    ...
                    const selectedCourse = state.courses.find((course) => String(course.id) === String(value));
                    setLinkedCourseId(value);
                    setLinkedCourseTitle(selectedCourse?.title || "");
                  }}
                >
                  <SelectTrigger id="task-course" className="h-10">
                    <SelectValue placeholder="General task" />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="__general__">General task</SelectItem>
